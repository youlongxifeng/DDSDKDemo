...
import com.dd.sdk.netbean.VideoPictureBean;
...
public class PostUploadRequest extends Request<String> {
    ...
    /*请求 数据通过参数的形式传入*/
    private List<VideoPictureBean> mListItem ;

    private String BOUNDARY = "--------------"; //数据分隔线
    private String MULTIPART_FORM_DATA = "multipart/form-data";

    public PostUploadRequest(String url, List<VideoPictureBean> listItem, Response.Listener listener, Response.ErrorListener errlistener) {
